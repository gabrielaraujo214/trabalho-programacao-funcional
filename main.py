...
from medidor_velocidade import MedidorVelocidade 
...
caminho_imagem_carro = get_resource_path("./img/carro1.png")
carro = Carro(tela, caminho_imagem_carro, posicoes_fixas, tamanho_carro)

caminho_imagem_cenario = get_resource_path("./img/cenario1.png")
cenario = Cenario(LARGURA_TELA, ALTURA_TELA, caminho_imagem_cenario)

caminho_imagem_obstaculo = get_resource_path("./img/carro3.png")
obstaculos = []
for _ in range(2):
