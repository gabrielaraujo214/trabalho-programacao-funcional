...
class Carro:
    ...
    def processar_eventos(self, evento):
        """Atualiza a posição do carro com base no evento."""
    ...
    def atualizar_rastro(self):
        """Adiciona a posição atual ao rastro e limita seu tamanho."""
    ...
    def desenhar_rastro(self):
        """Desenha o rastro do carro na superfície."""
    ...
    def desenhar(self):
        """Desenha o rastro e o carro na tela."""
